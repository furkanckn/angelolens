  ...
  return (
    <section className="relative overflow-hidden bg-anthracite text-cream">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 50% 40%, rgba(176,141,87,0.28), transparent 68%), radial-gradient(ellipse 45% 35% at 85% 85%, rgba(247,244,239,0.05), transparent 55%)",
        }}
      />

      <div className="relative mx-auto grid max-w-6xl items-center gap-2 px-5 sm:px-6 md:px-10 lg:grid-cols-2 lg:gap-8">
        <motion.div
        ...
        >
          <div className="relative mx-auto aspect-[4/3] w-full max-w-xl lg:max-w-none">
            <Image
              ...
              fill
              quality={95}
              className="object-contain object-center p-4 sm:p-8 lg:p-8"
              style={{
                filter:
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center px-5 pb-16 pt-2 text-center sm:px-8 lg:px-10 lg:pb-20 lg:pt-16"
        >
          <p className="text-[11px] font-medium tracking-[0.22em] text-gold-light uppercase">
            {packaging("title")}
          </p>

          <div className="mx-auto mt-7 h-px w-12 bg-gold/50" aria-hidden />

          <blockquote className="mt-8 max-w-md space-y-4">
          ...
          <p className="mx-auto mt-10 max-w-sm text-sm leading-relaxed text-cream/55">
            {packaging("body")}
          </p>
          <p className="mx-auto mt-3 max-w-sm text-xs tracking-[0.08em] text-cream/40">
            {spirit("note")}
          </p>
        </motion.div>
      </div>
